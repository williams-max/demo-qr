 ...
 */
 ...
 export const mowStrings = new LocalizedString({
     ...
     en: {
         ...
         loadingMessages: {
             pleaseWait: 'Please wait...',
             preparing: "mowShop Theme is preparing..."
         },
         alertDialogs: {
             success: "Successful!",
             warning: "Warning!",
         ...
         introScreens: {
             page1Title: "BUY ONLINE",
             page1Content: "Purchase products easily from your phone. Enjoy shopping!",
             page2Title: "SEARCH ONLINE",
             page2Content: "Discover thousands of products in one place and make your choice. Add desired products to your cart without losing time.",
             page3Title: "WORLDWIDE DELIVERY",
             page3Content: "The products you have purchased are shipped without delay and delivered to you safely."
         },
         homeScreen: {
         ...
         productDetail: {
             ...
             title2: "Product Detail 2",
             title3: "Product Detail 3",
             ...
             computerMemorySize: "Computer Memory Size"
         },
         addressList: {
             title: "My Addresses",
         ...
         cargoTracking: {
             ...
             copiedToClipBoard: "Cargo Tracking Number is copied"
         },
         rateProduct: {
             title: "Rate Product",
         ...
         shopDetail: {
             ...
             blockShop: "Block This Shop",
             unBlockShop: "Unblock This Shop",
     ...
     de: {
         ...
         homeScreen: {
             ...
             cartDiscount: "Rabatt im Warenkorb"
         },
         drawerMenu: {
             faq: "FAQ.",
             settings: "Settings",
     ...
     es: {
         appName: "Productos y Servicios",
         profile: "Perfil",
         newHere: "Eres nuevo aqui",
